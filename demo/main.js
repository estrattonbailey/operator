...
var Operator = function () {
  ...
  _createClass(Operator, [{
    ...
    value: function setState(_ref) {
      ...
      _state2.default.route = route;
      title ? _state2.default.title = title : null;

      (0, _links2.default)(route);
