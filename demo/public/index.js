...
/******/ 	var hotCurrentHash = "960ec40dc9e675e310dd"; // eslint-disable-line no-unused-vars
...
var _operator = __webpack_require__(3);

var _operator2 = _interopRequireDefault(_operator);

var _micromanager = __webpack_require__(2);
...
function mount() {
  for (var type in types) {
    ...
    for (var i = 0; i < nodes.length; i++) {
      ...
      try {
        var instance = __webpack_require__(4)("./" + path + '/' + name + '.js').default(nodes[i]);
...
var _unfetch = __webpack_require__(1);

var _unfetch2 = _interopRequireDefault(_unfetch);

var _scrollRestoration = __webpack_require__(12);
...
var map = {
	"./components/markdown.js": 5,
	"./components/readme.js": 6,
	"./index.js": 0
};
...
exports.default = function (content) {
  if (!readme) {
    (0, _unfetch2.default)('https://api.github.com/repos/estrattonbailey/operator.js/readme').then(function (res) {
      return res.json();
    }).then(function (res) {
      readme = (0, _marked2.default)(window.atob(res.content));
